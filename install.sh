...
# Formatieren der Festplatte (nehmen wir an, die Festplatte ist /dev/nvme0n1p1, ersetze dies ggf.)
parted /dev/nvme0n1p1 mklabel gpt
parted /dev/nvme0n1p1 mkpart primary ext4 1MiB 100%
